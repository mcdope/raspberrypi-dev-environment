...
echo "           in the emulated enviroment and connect with ssh -p 5022 pi@localhost from "
echo "           your host enviroment."
echo
echo "           To globally change the layout, and other config stuff, run sudo raspi-config"
echo "           in the emulated enviroment. Oh and by the way, use [CTRL]+[ALT] to release "
